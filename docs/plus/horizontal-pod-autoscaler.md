...
!!! tip ""
    [API Reference](../../reference/cdk8s-plus-26/typescript.md#horizontalpodautoscaler)
...
For more information on HorizontalPodAutoscaler check out the [API Reference](../reference/cdk8s-plus-26/typescript.md#horizontalpodautoscaler).
