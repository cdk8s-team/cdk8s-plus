...
!!! tip ""
    [API Reference](../../reference/cdk8s-plus-31/typescript.md#horizontalpodautoscaler)
...
For more information on HorizontalPodAutoscaler check out the [API Reference](../reference/cdk8s-plus-31/typescript.md#horizontalpodautoscaler).
