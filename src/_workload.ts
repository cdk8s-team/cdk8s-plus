 ...
 */
export interface WorkloadProps extends ResourceProps {
...
export interface TemplatedWorkloadProps extends WorkloadProps {
  /**
...
export abstract class TemplatedWorkload extends Workload {
  ...
  constructor(scope: Construct, id: string, props: TemplatedWorkloadProps = {}) {
...
export interface LongRunningWorkloadProps extends TemplatedWorkloadProps {
...
export abstract class LongRunningWorkload extends TemplatedWorkload {
