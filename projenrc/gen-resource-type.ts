...
/**
 * Generate a source file for the `ResourceType` module, based on information about API
 ...
 */
export function generateResourceType(project: Project, sourcePath: string, outputPath: string) {
